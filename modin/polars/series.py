...
class Series(BasePolarsDataset):
    ...
    def cum_count(self) -> "Series":
        ...
        """
        return self.__constructor__(_data=self._query_compiler.isna().cumsum())
    ...
    def cum_max(self) -> "Series":
        ...
        """
        return self.__constructor__(_data=self._query_compiler.cummax())
    ...
    def cum_min(self) -> "Series":
        ...
        """
        return self.__constructor__(_data=self._query_compiler.cummin())
    ...
    def cum_prod(self) -> "Series":
        ...
        """
        return self.__constructor__(_data=self._query_compiler.cumprod())
    ...
    def cum_sum(self) -> "Series":
        ...
        """
        return self.__constructor__(_data=self._query_compiler.cumsum())
    ...
    def is_nan(self) -> "Series":
        ...
        """
        return self.__constructor__(_data=self._query_compiler.isna())
    ...
    def is_not_nan(self) -> "Series":
        ...
        """
        return self.__constructor__(_data=self._query_compiler.notna())
    ...
    def to_frame(self, name: str | None = None) -> "DataFrame":
        ...
        return DataFrame(_data=self._query_compiler).rename({self.name: name})
    ...
    def append(self, other: "Series") -> "Series":
        ...
        """
        return self.__constructor__(
            _data=self._query_compiler.concat(0, other._query_compiler)
        )
    ...
    def zip_with(self, mask: "Series", other: "Series") -> "Series":
        ...
        """
        return self.__constructor__(
            _data=self._query_compiler.where(
    ...
    def __radd__(self, other) -> "Series":
        ...
        Returns:
            Added Series.
        """
        return self.__constructor__(_data=self._query_compiler.radd(other, axis=0))
    ...
    def __rand__(self, other) -> "Series":
        ...
        Returns:
            And Series.
        """
        return self.__constructor__(_data=self._query_compiler.__rand__(other, axis=0))
    ...
    def __rfloordiv__(self, other) -> "Series":
        ...
        Returns:
            Floored Series.
        """
        return self.__constructor__(_data=self._query_compiler.rfloordiv(other, axis=0))
    ...
    def __rmod__(self, other) -> "Series":
        ...
        Returns:
            Modulo Series.
        """
        return self.__constructor__(_data=self._query_compiler.rmod(other, axis=0))
    ...
    def __rmul__(self, other) -> "Series":
        ...
        Returns:
            Multiplied Series.
        """
        return self.__constructor__(_data=self._query_compiler.rmul(other, axis=0))
    ...
    def __ror__(self, other) -> "Series":
        ...
        Returns:
            Or Series.
        """
        return self.__constructor__(_data=self._query_compiler.__ror__(other, axis=0))
    ...
    def __rpow__(self, other) -> "Series":
        ...
        Returns:
            Powered Series.
        """
        return self.__constructor__(_data=self._query_compiler.rpow(other, axis=0))
    ...
    def __rsub__(self, other) -> "Series":
        ...
        Returns:
            Subtracted Series.
        """
        return self.__constructor__(_data=self._query_compiler.rsub(other, axis=0))
    ...
    def __rtruediv__(self, other) -> "Series":
        ...
        Returns:
            Divided Series.
        """
        return self.__constructor__(_data=self._query_compiler.rtruediv(other, axis=0))
    ...
    def __rxor__(self, other) -> "Series":
        ...
        Returns:
            Xor Series.
        """
        return self.__constructor__(_data=self._query_compiler.__rxor__(other, axis=0))
    ...
    def eq(self, other) -> "Series":
        ...
        """
        return self.__constructor__(
            _data=self._query_compiler.eq(other._query_compiler)
        )
    ...
    def ge(self, other) -> "Series":
        ...
        """
        return self.__constructor__(
            _data=self._query_compiler.ge(other._query_compiler)
        )
    ...
    def gt(self, other) -> "Series":
        ...
        """
        return self.__constructor__(
            _data=self._query_compiler.gt(other._query_compiler)
        )
    ...
    def le(self, other) -> "Series":
        ...
        """
        return self.__constructor__(
            _data=self._query_compiler.le(other._query_compiler)
        )
    ...
    def lt(self, other) -> "Series":
        ...
        """
        return self.__constructor__(
            _data=self._query_compiler.lt(other._query_compiler)
        )
    ...
    def ne(self, other) -> "Series":
        ...
        """
        return self.__constructor__(
            _data=self._query_compiler.ne(other._query_compiler)
        )
    ...
    def pow(self, exponent) -> "Series":
        ...
        Returns:
            Powered Series.
        """
        return self.__constructor__(_data=self._query_compiler.pow(exponent, axis=0))
    ...
    def drop_nans(self) -> "Series":
        ...
        """
        return self.__constructor__(_data=self._query_compiler.dropna(how="any"))
